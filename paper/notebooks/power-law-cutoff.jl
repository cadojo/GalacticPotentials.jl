...
# ╔═╡ e8cba3c5-993e-4071-a039-3b5b1c62e7ac
begin
	using PlutoUI
...
# ╔═╡ 982dfcaa-31aa-11ef-399b-2d84328c4b14
md"""
# 🌌 Power Law Cutoff Potential

$(PlutoUI.TableOfContents())
"""

# ╔═╡ 66f0025a-6338-4410-aad6-0f3e4f2799ae
md"""
## Special Functions
"""

# ╔═╡ b24650c3-7e24-4c8c-9fbc-aef7d5d2a671
md"""
The power law cutoff potential requires the gamma function, and the lower incomplete gamma function.
"""

# ╔═╡ 4bfa98e2-2991-46bf-80f3-c98904bccace
"""
...
# ╔═╡ ce37340d-b31c-4995-8166-78463cbf110e
md"""
## Function Registration
We need to register both `gamma` and `lowergamma` with `Symbolics.jl`. I'm adding `Real` to all argument types to _try_ to prevent specialization. 
"""

# ╔═╡ e948709d-cd8d-4ffc-831e-9597a6061d88
begin
...
# ╔═╡ 1d37c84c-2e3e-4262-b345-aea0f8d08773
"""
...
# ╔═╡ 5d9bdec5-16e4-4cae-ba4e-4f333c38b4b7
md"""
## Potential Value
The power law cutoff potential has the following integral form. 
"""

# ╔═╡ 7542a885-fd22-46cb-9f96-b25af77a2faa
potential = begin
    @variables t
...
# ╔═╡ c31eea2b-991a-4b41-bf01-5acfb04d96df
md"""
## Potential Gradient: Attempt #1

The gradient of the potential requires differentiating with respect to $x, $y, and $z. 

!!! note
	This fails because no derivatives are deefined for the registered `lowergamma` function.
"""

# ╔═╡ 1b3e6518-c741-45b1-84c5-1d845c63c811
system1 = let
	dvs = map(Differential(t), u)
	eqs = dvs .~ Symbolics.gradient(potential, u)

	ODESystem(eqs, t; name = :PowerLawCutoffVectorField)
end

# ╔═╡ a8025fab-226d-4897-b2ff-88fef5e80c90
md"""
## Derivative Registration

We can register the derivatives of the `lowergamma` function using `ForwardDiff`.
"""

# ╔═╡ 1f9c42e0-cb4f-43fc-8070-f67415fcb39e
function Symbolics.derivative(::typeof(lowergamma), args::NTuple{2, Any}, ::Val{1})
    x, y = args
    return ForwardDiff.derivative(x -> lowergamma(x, y), x)
end

# ╔═╡ ed22c57a-c2fd-4be9-a151-66855e35568d
function Symbolics.derivative(::typeof(lowergamma), args::NTuple{2, Any}, ::Val{2})
    x, y = args
    return ForwardDiff.derivative(y -> lowergamma(x, y), y)
end

# ╔═╡ e888cd38-de00-465d-8901-93f13cc5e935
md"""
## Potential Gradient: Attempt #2

Even after registering the derivatives, taking the gradient of the value still fails.
"""

# ╔═╡ 5bbc9637-c03b-4521-9c28-2893c361666a
system2 = let
	dvs = map(Differential(t), u)
	eqs = dvs .~ Symbolics.gradient(potential, u)
...
manifest_format = "2.0"
project_hash = "b089bcaee34dc7b258a48258bcf42f95df11e8ad"
